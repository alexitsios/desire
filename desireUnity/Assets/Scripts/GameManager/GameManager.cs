...
public class GameManager : MonoBehaviour
{
	...
	public TranslationManager TranslationManager => GetComponent<TranslationManager>();
	//
    ...
    */
	...
	private void Update()
	{
		if(isPlaying)
		{
			...
			var dialogPosition = new Vector3(posX, Input.mousePosition.y - offsetY, 0);
    ...
    */
	...
	public void SetInteractDialogText(string text)
	{
		...
		{
			translatedItemName = playerInteraction.GetTranslatedActiveItemName() + " > ";
		}
		else
		{
			translatedItemName = playerInteraction.GetTranslatedActiveItemName();
